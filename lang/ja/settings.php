...
$lang['group_by_name']         = 'ユーザー名の文字による users グループの名前空間';
...
$lang['userlink_classes']      = '[<code>Logged in as</code>] インターウィキリンクに適用する CSS クラスのスペース区切り一覧（デフォルト： <code>interwiki wikilink1</code>）';
