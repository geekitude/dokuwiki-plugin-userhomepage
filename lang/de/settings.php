...
$lang['userlink_classes']      = 'Durch Leerzeichen getrennte Liste von CSS-Klassen die auf  [<code>Logged in as</code>] Interwiki-Links angewendet werden (Default: <code>interwiki wikilink1</code>).';
