 ...
 */
    ...
    $lang['templates_path'] = 'Pfad der Templates (userhomepage_private.txt and userhomepage_public.txt), z.B. <code>data/pages/user</code> oder <code>lib/plugins/userhomepage</code>';
